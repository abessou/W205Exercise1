...
echo removing existing table directories
hadoop fs -rm -R /user/ckekeh/exercise1/*

echo create table directories
hadoop fs -mkdir /user/ckekeh/exercise1/hospitals
hadoop fs -mkdir /user/ckekeh/exercise1/effective_care
hadoop fs -mkdir /user/ckekeh/exercise1/readmissions
hadoop fs -mkdir /user/ckekeh/exercise1/surveys_responses
hadoop fs -mkdir /user/ckekeh/exercise1/measure_dates
