...
hadoop fs -put ~/data/downloads/exercise1/hospitals.csv /user/ckekeh/exercise1/hospitals.csv
hadoop fs -put ~/data/downloads/exercise1/effective_care.csv /user/ckekeh/exercise1/effective_care.csv
hadoop fs -put ~/data/downloads/exercise1/readmissions.csv /user/ckekeh/exercise1/readmissions.csv
hadoop fs -put ~/data/downloads/exercise1/measure_dates.csv /user/ckekeh/exercise1/measure_dates.csv
hadoop fs -put ~/data/downloads/exercise1/surveys_responses.csv /user/ckekeh/exercise1/survey_responses.csv
